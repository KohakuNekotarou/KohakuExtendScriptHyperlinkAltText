...
#ifndef __KESHATScriptingDefs_h__
#define __KESHATScriptingDefs_h__
...
// Property IDs
enum KESHATScriptProperties
{
	p_KESHATHyperlinkAltText = 'KHAT',
};

#endif // __KESHATScriptingDefs_h__
